    	...
    	<div class="modal-content">
	      	...
	      	<div class="modal-body">
	        	...
	        	<div class="form-group">
	        		<input type="number" name="user_id" id="user_id" class="form-control" value="1" placeholder="Enter Your ID" />
	        	</div>
                <div class="form-group">
	        		<input type="text" name="user_name" id="user_name" class="form-control" value="name" placeholder="Enter Your Name" />
	        	</div>
                <div class="form-group">
        ...
        $.ajax({
            ...
            success:function(data)
            {
                ...
                if(data.review_point.length > 0)
                {
                    ...
                    for(var count = 0; count < data.review_point.length; count++)
                    {
                        html += '<div class="row mb-3">';

                        html += '<div class="col-sm-1"><div class="rounded-circle bg-danger text-white pt-2 pb-2"><h3 class="text-center">'+data.review_point[count].user_name.charAt(0)+'</h3></div></div>';
                        ...
                        html += '<div class="col-12">'; //font size mila hai
                        ...
                        html += '<div class="col-6 text-center"> <img class="w-50" src="'+data.review_point[count].attachment+'"></div>';

                        html += '</div>';

                        html += '<div class="card-footer text-right">On '+data.review_point[count].datetime+'</div>';
